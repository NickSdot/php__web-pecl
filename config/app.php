...
return [
     ...
     */
    'env' => $_SERVER['PECL_ENV'] ?? 'prod',

    /**
     * PECL channel URL scheme (http or https)
     */
    'scheme' => $_SERVER['PECL_SCHEME'] ?? 'https',

    /**
     * PECL channel URL host (domain name)
     */
    'host' => $_SERVER['PECL_HOST'] ?? 'pecl.php.net',

    /**
     * Database username
     */
    'db_username' => $_SERVER['PECL_DB_USERNAME'] ?? 'nobody',

    /**
     * Database password
     */
    'db_password' => $_SERVER['PECL_DB_PASSWORD'] ?? 'password',

    /**
     * Database name
     */
    'db_name' => $_SERVER['PECL_DB_NAME'] ?? 'pecl',

    /**
     * Database host
     */
    'db_host' => $_SERVER['PECL_DB_HOST'] ?? 'localhost',
     ...
     */
    'db_dsn' => $_SERVER['PEAR_DATABASE_DSN'] ?? '',
     ...
     */
    'rest_dir' => $_SERVER['PEAR_REST_DIR'] ?? __DIR__ . '/../public_html/rest',

    /**
     * Temporary generated application files
     */
    'tmp_dir' => $_SERVER['PECL_TMP_DIR'] ?? __DIR__ . '/../var',

    /**
     * Temporary directory for uploaded files
     */
    'tmp_uploads_dir' => $_SERVER['PECL_TMP_UPLOADS_DIR'] ?? __DIR__ . '/../var/uploads',

    /**
     * Path where new PECL account requests are sent when requesting also PHP.net
     * account.
     */
    'php_master_api_url' => $_SERVER['PECL_MASTER_API_URL'] ?? 'https://main.php.net/entry/svn-account.php',

    /**
     * Packages directory
     */
    'packages_dir' => $_SERVER['PECL_PACKAGES_DIR'] ?? __DIR__ . '/../public_html/packages',
